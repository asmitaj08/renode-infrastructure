...
namespace Antmicro.Renode.Peripherals.UART
{
    ...
    public class EFR32_USART_Fuzz : EFR32_GenericUSART, IDoubleWordPeripheral
    {
        public EFR32_USART_Fuzz(IMachine machine, uint clockFrequency = 19000000) : base(machine, clockFrequency)
        {
