...
namespace Antmicro.Renode.Peripherals.CPU
{
    public partial class CortexM
    {
        public override void SetRegister(int register, RegisterValue value)
        {
            ...
            // Console.WriteLine($"^^^^^^^^Setting register : {(CortexMRegisters)register} : {r.Index} with {value:X}");
        ...
        public override RegisterValue GetRegister(int register)
        {
            ...
            // Console.WriteLine($"^^^^^^^^Reading register : {(CortexMRegisters)register} :: {r.Index}, ret val :{GetRegisterValue32(r.Index):X}");
